...
<body>
    <div class="container">
        ...
        <main>
            ...
            <section id="offer" class="mt-5">
                ...
                <ul class="list-group list-group-flush">
                    <li style="list-style: none;"><strong>Extensive Book Collection:</strong> Dive into our extensive library featuring a wide range of genres, including fiction, non-fiction, mystery, romance, science fiction, fantasy, self-help, and more.</li>
                    <li style="list-style: none;"><strong>Author Spotlight:</strong> Discover talented authors and explore their captivating stories.</li>
                    <li style="list-style: none;"><strong>User-Friendly Experience:</strong> Enjoy seamless navigation, intuitive search features, and personalized recommendations.</li>
            ...
            <section id="team" class="mt-5">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="card mb-3 d-flex justify-content-center align-items-center shadow-sm p-3 bg-white rounded" style="height: 12rem;">
        ...
        <footer class="mt-3 py-1 bg-light text-dark text-center">
            <p class="mt-1"><b>&copy; 2024 BookHauler. All rights reserved.</b></p>
        </footer>

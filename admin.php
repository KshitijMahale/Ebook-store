...
?>
	...
	<body>
		<div class="container">
			...
			<form action="search_book.php" method="get" style="width: 100%; max-width: 30rem">
							...
							?>
								<tr>
									...
									<td>
										...
										<a href="php/delete-book.php?id=<?= $book['id'] ?>" class="btn btn-danger" style="margin-top: 0.3rem;">
											Delete</a>
									</td>
								</tr>
							<?php } ?>
